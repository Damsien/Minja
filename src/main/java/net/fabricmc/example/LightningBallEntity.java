...
public class LightningBallEntity extends ThrownItemEntity {
    public LightningBallEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public LightningBallEntity(World world, LivingEntity owner) {
        super(Minja.LightningBallEntityType, owner, world); // null will be changed later
    }

    public LightningBallEntity(World world, double x, double y, double z) {
        super(Minja.LightningBallEntityType, x, y, z, world); // null will be changed later
    }

    @Override
    protected Item getDefaultItem() {
        return Minja.lightningBallItem;
    }
